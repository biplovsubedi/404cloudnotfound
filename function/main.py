...
def weather_status(weather):
    ...
    if w_id in weather_condition_good:
        return "Good Morniing {}, today you'll see " +w_desc+" Have a wonderful day :) "

    if w_id in weather_condition_bad:
        return "Good Morniing {}, today you'll see " +w_desc+" Have a wonderful day :) "

    if w_id in weather_condition_severe:
        return "Good Morniing {}, today you'll see " +w_desc+" Please consider staying back at home  as weather conditions may get worse, Have a Wonderful Day :) "
...
def process_all_users():
	...
	for user in all_users:
		...
		home_weather_status = weather_status(home_weather)
